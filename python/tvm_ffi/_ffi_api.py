...
if TYPE_CHECKING:
    ...
    from tvm_ffi import Device, Module, Object, StructuralKey as _StructuralKey, StructuralVisitor as _StructuralVisitor, VisitInterrupt as _VisitInterrupt
...
if TYPE_CHECKING:
    ...
    def ContainerFindFirstNonCPUDevice(_0: Any, /) -> Device: ...
    ...
    def FunctionFromExternC(_0: c_void_p, _1: c_void_p, _2: c_void_p, /) -> Callable[..., Any]: ...
    ...
    def StructuralWalk(_0: Any, _1: Sequence[tuple[int, Callable[[Any], Any]]], _2: Sequence[tuple[int, Callable[[Any, int], Any]]], _3: int, /) -> _VisitInterrupt | None: ...
    def StructuralVisitor() -> _StructuralVisitor: ...
    def StructuralVisitorDefRegionKind(_0: _StructuralVisitor, /) -> int: ...
    def StructuralVisitorWithDefRegionKind(_0: _StructuralVisitor, _1: int, _2: Callable[[], Any], /) -> Any: ...
    def StructuralVisitorVisit(_0: _StructuralVisitor, _1: Any, /) -> _VisitInterrupt | None: ...
...
__all__ = [
    ...
    "ArraySize",
    "Bytes",
    "ContainerFindFirstNonCPUDevice",
    "DeepCopy",
    "Dict",
    "DictClear",
    "DictCount",
